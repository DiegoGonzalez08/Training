        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="home.jsp">GCIT Library</a>
            </div>
              ...
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="authors.jsp">Manage Authors</a></li>
                    <li><a href="publishers.jsp">Manage Publishers</a></li>
                    <li><a href="genre.jsp">Manage Genres</a></li>
                    <li><a href="books.jsp">Manage Books</a></li>
